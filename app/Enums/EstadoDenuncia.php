...
enum EstadoDenuncia: string
{
    ...
    public function transicionesValidas(): array
    {
        return match ($this) {
            ...
            self::Vista => [self::Vista ,self::EnProgreso, self::Resuelta],
            self::EnProgreso => [self::EnProgreso, self::Resuelta, self::Cerrada, self::Archivada],
            self::Resuelta => [self::Vista, self::EnProgreso, self::Cerrada],
            self::Cerrada => [self::Cerrada, self::EnProgreso, self::Archivada],
            self::Archivada => [self::Archivada, self::EnProgreso, self::Resuelta, self::Cerrada]
        };
    }
